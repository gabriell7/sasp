...
<input  type="text" name= "kommentti" value="<?php echo $merkinta[0]["kommentti"]; ?>" ><br>


<label for ="password">Intentsiteeti</label><br>
<input id="kayttajatunnus" type="text" value="<?php echo $merkinta[0]["intentsiteeti"]; ?>"name="intentsiteeti" required><br>


<label for="Suorituksen päiväys">Suorituksen päiväys:</label><br>
<input  id="kayttajatunnus" type="date" value="<?php echo $merkinta[0]["päiväys"]; ?>" name="päiväys">
